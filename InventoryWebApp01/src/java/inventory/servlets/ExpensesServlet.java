...
import inventory.logic.ExpensesLogic;
...
@WebServlet(name = "ExpensesServlet", urlPatterns = {"/ExpensesServlet"})
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if(strFormId.equals("1")) {
                ...
                ExpensesLogic CLogic = new ExpensesLogic();
                ArrayList<ExpensesObj> CArray = CLogic.getExpenses(iYear, iMonth, iDay, iYear2, iMonth2, iDay2);

                request.getSession().setAttribute("expenses", CArray);
                response.sendRedirect("expensesForm.jsp");
            }
