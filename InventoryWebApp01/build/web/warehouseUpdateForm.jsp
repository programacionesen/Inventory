<%@page import="inventory.objects.WarehouseObj"%>
...
<html>
    ...
    <% 
        WarehouseObj warehouse = (WarehouseObj) request.getSession().getAttribute("warehouse");
    ...
    <body>
        ...
        <form id="myform" name="myform" action="WarehouseServlet" method="get">
            <label>ID:</label><br>
            <input type="number" id="nonId" name="nonId" value="<%= warehouse.getId() %>" disabled>
            <br><br>
            
            <label>Name:</label><br>
            <input type="text" id="name" name="name" value="<%= warehouse.getName() %>">
            <br><br>
                ...
                <%
                    if(iteStoreArray!=null)
                    {
                        ...
                        while(iteStoreArray.hasNext())
                        {
                            ...
                            if(CStoreTemp.getId() == warehouse.getIdStore()) {
                %>
            ...
            <input type="hidden" id="id" name="id" value="<%= warehouse.getId() %>">
        </form>
        <div>
